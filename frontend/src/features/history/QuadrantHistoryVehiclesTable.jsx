...
function createData(
  ...
  return { id, vehiclePlate, type, organizationCode, deployAt, retractAt };
}

export default function QuadrantHistoryVehiclesTable(props) {
  ...
  const vehicleLogs = props.vehicleLogs;
...
QuadrantHistoryVehiclesTable.propTypes = {
  vehicleLogs: PropTypes.array.isRequired,
};
