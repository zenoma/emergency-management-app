...
\begin{document}
 ...
 \dedicatoria{It's not a lake. It's an ocean.} % escribe neste comando o teu texto de dedicatoria
 \paxinaenbranco
...
También agradezco a mis compañeros y profesorado del Master Universitario de Ingeniería Informática(MUEI) que me han ayudado a mejorar como
informático y como persona.\\
 ...
 \include{contido/2-tecnoloxia}
 \include{contido/3-arte}
 \include{contido/4-viabilidade}
 \include{contido/5-desenrolo}
 \include{contido/6-planificacion}
 \include{contido/7-requisitos}
 \include{contido/8-deseño}
 \include{contido/9-implementacion}
 \include{contido/10-probas}
 \include{contido/11-conclusions}
