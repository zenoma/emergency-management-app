...
Otro cambio relevante es que las relaciones históricas se han vuelto más precisas y homogéneas. La etapa anterior separaba parte de la trazabilidad por tipos de recurso; aquí, en cambio, el modelo de asignaciones y logs unifica esa información y permite consultar de forma más clara qué recurso estuvo vinculado a qué emergencia, en qué cuadrante y en qué momento.
...
Además, esta capa no solo recupera datos, sino que también soporta operaciones de envío, como la creación de avisos o la notificación de dispositivos, lo que encaja bien con el papel de la app como cliente móvil ligero que delega la lógica de negocio en el backend.
