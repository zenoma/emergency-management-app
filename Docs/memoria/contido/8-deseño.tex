...
Se ha utiliado el color verde para los nuevos componentes añadidos respecto al trabajo previo, la gestión de registros y  el motor de reglas de recomendación. Los otros componentes ya existían pero se han ampliado notablemente para dar soporte a las nuevas funcionalidades, como la gestión de asignaciones, la vinculación de emergencias a cuadrantes. Por ejemplo, el componente de dominio ha sido ampliado con nuevas entidades y relaciones, mientras que los servicios fachada han incorporado operaciones para gestionar asignaciones y reglas de recomendación.
