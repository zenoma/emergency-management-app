...
Se ha revisado que las aplicaciones que ya han sido comentadas en el trabajo previo \cite{TFGAdrianGarcia2025} no han sufrido cambios significativos en su enfoque o funcionalidades. Como el alcance de la solución se ha ampliado, se han investigado nuevas herramientas que cuenten con una solución móvil, ya que es un aspecto clave en la propuesta de este proyecto y se ha reforzado en esta nueva etapa. 
