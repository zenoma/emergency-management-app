...
Para la realización de este \acrshort{tfm} se ha estimado una duración aproximada de cuatro meses. Dicha planificación incluye las fases de análisis, diseño, implementación, pruebas y redacción de la memoria. Además, se contempla la familiarización de las nuevas tecnologías. Dado el alcance definido la viabilidad temporal es aceptable y no representa un riesgo crítico para la finalización del proyecto.
...
Para el estudio de viablidad tecnológica se han considerado las tecnologías heredadas del \acrshort{tfg}, así como las nuevas tecnologías propuestas para el desarrollo de la aplicación móvil y la integración de notificaciones push.

En resumen, el stack tecnológico propuesto para el \acrshort{tfm} es el siguiente:
\begin{itemize}
...
La dimensión económica no supone un riesgo significativo para la ejecución del \acrshort{tfm} pues los costes directos son bajos.

\section{Conclusión del análisis de viabilidad}
En resumen, el proyecto es totalmente viable porque combina un plan de trabajo realista de cuatro meses con un uso inteligente de la tecnología. Al reutilizar la base del \acrshort{tfg} y apoyarse en herramientas gratuitas y potentes como Kotlin y \acrshort{fcm}, el riesgo técnico es mínimo y el coste es prácticamente cero. Esta experiencia previa, sumada a una planificación clara, garantiza que el proyecto se pueda terminar a tiempo y con la calidad necesaria para un \acrshort{tfm}.
