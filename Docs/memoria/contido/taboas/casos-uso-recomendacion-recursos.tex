\begin{table}[H]
  ...
  \hline
  Descripción & Un coordinador consulta la propuesta de recursos sugeridos para una emergencia activa, separando equipos y vehículos para poder iniciar la asignación con mayor rapidez. \\
  \hline
...
\begin{table}[H]
  ...
  \hline
  Descripción & El sistema genera recomendaciones automáticas a partir de la tipología de la emergencia, la distancia de los recursos, su estado operativo y la organización de procedencia, con el fin de priorizar los candidatos más adecuados. \\
  \hline
...
\begin{table}[H]
  ...
  \hline
  Descripción & Un coordinador convierte una recomendación de recurso en una asignación operativa para iniciar el despliegue de forma rápida, reutilizando el recurso sugerido y el contexto de la emergencia o del cuadrante. \\
  \hline
