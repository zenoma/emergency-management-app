\begin{table}[H]
  ...
  \hline
  Descripción & Un miembro de equipo recibe una notificación móvil cuando se crea una asignación pendiente sobre uno de sus recursos para poder acceder rápidamente a la intervención. \\
  \hline
...
\begin{table}[H]
  ...
  \hline
  Descripción & Un miembro de equipo o un gestor recibe una notificación cuando una asignación cambia a aceptada, liberada o completada para tener visible al instante el estado operativo del recurso. \\
  \hline
...
\begin{table}[H]
  ...
  \hline
  Descripción & Un coordinador o un miembro de equipo recibe un aviso cuando una modificación en la emergencia o en el cuadrante afecta a una asignación ya creada y requiere revisión. \\
  \hline
