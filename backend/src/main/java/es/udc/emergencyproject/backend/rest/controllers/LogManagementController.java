...
import es.udc.emergencyproject.backend.rest.mappers.EmergencyQuadrantLogMapper;
import es.udc.emergencyproject.backend.rest.mappers.GlobalStatisticsMapper;
import es.udc.emergencyproject.backend.rest.mappers.TeamQuadrantLogMapper;
import es.udc.emergencyproject.backend.rest.mappers.VehicleQuadrantLogMapper;
