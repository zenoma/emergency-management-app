package es.udc.emergencyproject.backend.model.services.resources.impl;
...
import es.udc.emergencyproject.backend.model.services.resources.VehicleService;
...
public class VehicleServiceImpl implements VehicleService {
  ...
  public void dismantleVehicleById(Long id) throws InstanceNotFoundException, AlreadyDismantledException {
    ...
    if (vehicle.getDismantleAt() == null) {
      //TODO: cuando se borra un equipo hay que quitarlo de sus cuadrantes asignados
