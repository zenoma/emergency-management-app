package es.udc.emergencyproject.backend.model.services.logsmanagement;
...
public class LogManagementServiceImpl implements LogManagementService {
  ...
  @Override
  public EmergencyQuadrantLog logEmergency(Emergency emergency, Quadrant quadrant) throws InstanceNotFoundException {
    return emergencyQuadrantLogRepository.save(
        new EmergencyQuadrantLog(emergency, quadrant, quadrant.getLinkedAt(),
